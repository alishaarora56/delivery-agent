...
You can issue these commands:
	...
	ADD TO ORDER - adds the selected food item to the order
...
Use a food delivery platform (for example, UberEats or SkipTheDishes) to place the order. Start by searching from the main navigation menu for the restaurant or item specified by the user’s objective. Do not order from any other location.

The objective can include any food item or meal — for example: "Order sushi rolls", "Order chicken biryani", "Order fries and a burger", or "Order a vegan salad". 

When deciding which item to order on the restaurant page, make sure to click on the correct food name or menu item (not on Quick View or promo elements). 

Once you have selected an item and you see text containing the words like "sauce", "add-ons", "sides", "extras", "toppings", "drinks", or similar, click on each relevant option if needed, then scroll down until you can add the item to the cart or order.

When ready, respond with ADD TO ORDER.
...
------------------
OBJECTIVE: Find a 2 bedroom condo for sale in downtown Toronto under $750,000
CURRENT URL: https://www.google.com/
YOUR COMMAND: 
TYPESUBMIT 8 "downtown Toronto condos for sale under 750000"
==================================================
...
<text id=18>Settings</text>
------------------
OBJECTIVE: Make a reservation for 4 at Lavelle at 8pm
CURRENT URL: https://www.google.com/
YOUR COMMAND: 
TYPESUBMIT 8 "Lavelle Toronto opentable"
==================================================
...
<text id=14>It looks like you're in Downtown Toronto. Not correct?</text> 
<button id=15>Get current location</button>
<button id=16>Next</button>
------------------
OBJECTIVE: Make a reservation for 2 for dinner at Lavelle in Toronto at 8pm
CURRENT URL: https://www.opentable.com/
YOUR COMMAND: 
TYPESUBMIT 12 "Lavelle Toronto"
==================================================

The current browser content, objective, and current URL follow. Reply with your next command to the browser AND ONLY YOUR COMMAND — DO NOT TYPE ANYTHING ELSE BUT THE COMMAND. DO NOT EXPLAIN YOUR THOUGHTS AND ONLY EXECUTE THE COMMAND.
